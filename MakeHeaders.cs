...
namespace PivasWebService
{
    public class MakeHeaders
    {
        ...
        public static string requestHeader(string msgCode, string payload)
        {
            ...
            requestHeaderJson.Append("}");
            requestHeaderJson.Append(",\"payload\":");
            requestHeaderJson.Append("{\"request\":" + payload + "}");
            requestHeaderJson.Append("}");
        ...
        public static string responseHeader(string reqMsgSerial, string msgCode, string err, string payload)
        {
            ...
            responseHeaderJson.Append("\"headers\":");
            responseHeaderJson.Append("{");
        ...
        public static string makePayLoad(string codeName, string code, List<string> msg)
        {
            StringBuilder responsePayload = new StringBuilder();
            responsePayload.Append("{");
            responsePayload.Append("\"response\":{");
            responsePayload.Append("\"" + codeName + "\":\"" + code + "\"");
            responsePayload.Append(",\"result\":\"" + msg[0] + "\"");
            responsePayload.Append(",\"resultText\":\"" + msg[1] + "\"");
            responsePayload.Append("}");
            responsePayload.Append(",\"errInfo\":{");
            responsePayload.Append("\"errCode\":\"" + msg[0] + "\"");
            responsePayload.Append(",\"msgErrType\":\"" + msg[2] + "\"");
