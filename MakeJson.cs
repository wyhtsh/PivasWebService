...
namespace PivasWebService
{
    public class MakeJson
    {
        ...
        {
            writeContent.writeLog(DateTime.Now.ToString("HHmmss"), Str);
            int info = 0;
            ...
            try
            {
                ...
                //if ("request" != headers["sendType"].ToString() || "PIVS" != headers["destination"].ToString() || "HISCHANNEL" != headers["channelFlag"].ToString() || "HIS" != headers["sysCode"].ToString() || "noBroadcast" != headers["msgType"].ToString())
                //{
                //    throw new Exception();
                //}
                ...
                Dictionary<string, object> rows1 = (Dictionary<string, object>)payload["request"];
